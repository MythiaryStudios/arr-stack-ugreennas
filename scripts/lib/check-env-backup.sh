...
check_env_backup() {
    ...
    local nas_env
    nas_env=$(timeout 10 sshpass -p '***REDACTED***' ssh -o StrictHostKeyChecking=no -o ConnectTimeout=5 mooseadmin@moosenas.local "cat /volume1/docker/arr-stack/.env" 2>/dev/null)
